...
n = 12 # number of input features.
m = 28 # number of training examples.
grad = np.zeros(shape = (n, 1))
theta = np.ones(shape=(n, 1), dtype = float)
hx = np.ones(shape=(m, 1), dtype = float)

file_handle = open("C:/Users/Devilal/Desktop/Workshop/Multivariat Linear Regression/data.csv", "r")
